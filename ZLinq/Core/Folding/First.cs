...
namespace ZLinq
{
    ...
    {     		
		...
		[Pure]
		public static T First<T>([NotNull] this IEnumerable<T> source, [NotNull] Predicate<T> predicate)
        {
			source.IsNotNull("source");
			predicate.IsNotNull("predicate");
		    foreach (T value in source)
		...
		[Pure]
	    public static T FirstOrDefault<T>([NotNull] this IEnumerable<T> source, [NotNull] Predicate<T> predicate)
        {
			source.IsNotNull("source");
			predicate.IsNotNull("predicate");
		    foreach (T value in source)
